class RunnerGameConstructor {
  constructor(
    ...
    this.easy.onclick = e => {
      this.gameFunction("anime_easy", 2000);
    };

    this.medium.onclick = e => {
      this.gameFunction("anime_medium", 1000);
    };

    this.hard.onclick = e => {
      this.gameFunction("anime_hard", 550);
    };
  }

  gameFunction(animation, speed) {
    ...
    this.btn.classList.add(animation);
...
let newGame = new RunnerGameConstructor(
  "#v",
  ".click",
  ".easy",
  ".medium",
